using p4g64.configFramework.Configuration;
...
internal class Utils
{
    ...
    internal static void LogDebug(string message)
    {
        if (_config.DebugEnabled)
            _logger.WriteLine($"[Config Framework] {message}");
    }
    ...
    {
        _logger.WriteLine($"[Config Framework] {message}: {e.Message}", System.Drawing.Color.Red);
    }

    internal static void LogError(string message)
    {
        _logger.WriteLine($"[Config Framework] {message}", System.Drawing.Color.Red);
    }
